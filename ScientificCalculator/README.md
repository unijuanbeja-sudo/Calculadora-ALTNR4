...
## Gramática inicial del lenguaje
...
## Generación del Lexer, Parser y Visitor
...
## Implementación del Visitor aritmético
...
## Primera ejecución de la calculadora
...
>
> Insertar aquí la captura de `ScientificCalc.g4` mostrando la regla `stat` con la nueva alternativa `plotExpr`, y de la terminal ejecutando `antlr4 -no-listener -visitor ScientificCalc.g4` sin errores.
...
>
> Insertar aquí la captura del método `visitPlotExpr` completo en `ScientificEvalVisitor.java`.
...
>
> Insertar aquí la captura de la clase `PlotWindow` (constructor y `paintComponent`).
...
>
> Insertar aquí la captura de la ventana "Scientific Calculator" mostrando la parábola de `plot(x^2,-10,10)`.



> **CAPTURA 14 - Gráfica del seno**
>
> Insertar aquí la captura de la ventana "Scientific Calculator" mostrando la onda de `plot(sin(x),-6.28,6.28)`.
...
>
> Insertar aquí la captura de la terminal ejecutando toda la secuencia anterior (aritmética + variables + funciones + `vars`), y de las dos ventanas gráficas resultantes.
...
>
> Insertar aquí la captura de la gramática y el Visitor con las funciones `asin`, `acos`, `atan`, `floor`, `ceil`, y de la terminal probándolas (p. ej. `asin(1)`, `floor(3.7)`, `ceil(3.2)`).
